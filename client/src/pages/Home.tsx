    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <motion.div className="absolute inset-0 z-0" style={{ y: heroY, scale: heroScale }}>
          ...
          {/* Extra light-mode overlay for better readability */}
          <div className="absolute inset-0 bg-background/30 dark:bg-transparent" />
          <div className="hero-bottom-fade absolute bottom-0 left-0 right-0 h-56" />
        </motion.div>
        ...
        <div className="marquee-container">
          <div className="marquee-track">
            {[...MARQUEE_ITEMS, ...MARQUEE_ITEMS, ...MARQUEE_ITEMS].map((item, i) => (
              <span key={i} className="flex items-center gap-3 px-8 text-sm font-['Nunito_Sans'] font-600 text-muted-foreground whitespace-nowrap">
